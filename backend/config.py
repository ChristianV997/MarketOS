...
_SERVICE_CREDENTIALS = {
    ...
    "mercadopago_mx": ["MERCADOPAGO_ACCESS_TOKEN"],
    "chatwoot": ["CHATWOOT_BASE_URL", "CHATWOOT_API_ACCESS_TOKEN", "CHATWOOT_ACCOUNT_ID"],
    "mautic": ["MAUTIC_BASE_URL", "MAUTIC_USERNAME", "MAUTIC_PASSWORD"],
    "activepieces": ["ACTIVEPIECES_BASE_URL", "ACTIVEPIECES_API_KEY"],
    "posthog_backend": ["POSTHOG_PROJECT_API_KEY"],
